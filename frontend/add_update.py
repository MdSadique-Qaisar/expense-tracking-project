...
def add_update_tab():
    selected_date = st.date_input("📅 Enter the date", value=datetime(2020, 1, 1))
    ...
    with st.form(key="expense_form"):
        ...
        for i in range(6):
            ...
            col1, col2, col3 = st.columns(3)
            with col1:
                amount_input = st.number_input("Expense Amount", min_value=0.0, value=amount, step=1.0, key=f"amount_{i}", label_visibility="collapsed")
            with col2:
